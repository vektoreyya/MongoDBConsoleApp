                    ...
                    case "3":
                        {
                            if (currentUser != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    Console.WriteLine($"E-mail: {targetUser.Email}");

                                    Console.WriteLine("Interests:");
                                    foreach (var val in targetUser.Interests)
                                    {
                                    ...
                                    foreach (var val in targetUser.Subscribers)
                                    {
                                        var sub = socialNetwork.FindUserById(val);
                                        Console.WriteLine($"\t{sub.FirstName} {sub.LastName}");
                                    }

                                    Console.WriteLine("Following:");
                                    foreach (var val in targetUser.Following)
                                    {
                                        var foll = socialNetwork.FindUserById(val);
                    ...
                    case "5":
                        {
                            if (currentUser != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    Console.WriteLine($"User to unsubscribe from id: {userToUnsubscribe.Id}");
